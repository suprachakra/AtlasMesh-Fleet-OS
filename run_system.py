...
Systematically starts and validates all 47 services
"""
    ...
    def __init__(self):
        self.services = {
            ...
            "tier1": [
                ...
                {"name": "trip-service", "port": 8083, "path": "services/trip-service"},
            ...
            "tier2": [
                {"name": "telemetry-ingest", "port": 8090, "path": "services/telemetry-ingest"},
                {"name": "telemetry-ingestion", "port": 8091, "path": "services/telemetry-ingestion"},
