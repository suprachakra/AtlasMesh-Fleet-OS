...
**Jump to:** [A) Company-Level OKRs](#a-company-level-okrs) · [B) Workstream OKRs](#b-workstream-okrs) · [C) Sector OKRs](#c-sector-okrs-lighthouse-specific) · [C.1) Interdependency Matrix](#c1-okr-interdependency-matrix) · [D) KPI Dictionary](#d-kpi-dictionary-unambiguous) · [E) Cadence & Reviews](#e-cadence-reviews-and-source-of-truth) · [F) Implementation & Governance](#f-implementation-plan--governance) · [G) Ethics & Compliance](#g-ethical--compliance-integration) · [H) Pre-Mortem](#h-pre-mortem-failure-scenarios) · [Final guardrail](#final-guardrail)
