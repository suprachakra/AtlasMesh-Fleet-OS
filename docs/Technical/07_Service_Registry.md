# AtlasMesh Fleet OS - Service Registry

## Overview

This document provides a comprehensive registry of all microservices in the AtlasMesh Fleet OS, their responsibilities, interfaces, and operational characteristics.
