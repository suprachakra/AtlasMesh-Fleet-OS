...
// Config represents the complete configuration for control center UI service
type Config struct {
...
func Load() (*Config, error) {
	...
	if configPath == "" {
		configPath = "configs/control-center-ui.yaml"
	}
...
func setDefaults(config *Config) {
	...
	// Dashboard defaults
	if config.Dashboard.DefaultLayout == "" {
		config.Dashboard.DefaultLayout = "default"
	}
	if config.Dashboard.RefreshInterval == 0 {
		config.Dashboard.RefreshInterval = 30
	}
