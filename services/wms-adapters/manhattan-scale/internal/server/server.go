...
import (
	...
	"github.com/atlasmesh/wms-adapters/manhattan-scale/internal/task"
	"github.com/atlasmesh/wms-adapters/manhattan-scale/internal/inventory"
	"github.com/atlasmesh/wms-adapters/manhattan-scale/internal/resource"
)
...
func setupRoutes(router *gin.Engine, taskMgr *task.Manager, inventoryMgr *inventory.Manager, resourceMgr *resource.Manager, logger *zap.Logger) {
	...
	router.GET("/health", func(c *gin.Context) {
		c.JSON(http.StatusOK, gin.H{
			...
			"service":   "manhattan-scale-adapter",
		})
	})
