...
// SAPEWMClient represents the SAP EWM client
type SAPEWMClient struct {
	baseURL    string
...
// SAPEWMConfig represents SAP EWM client configuration
...
// NewSAPEWMClient creates a new SAP EWM client
func NewSAPEWMClient(config *SAPEWMConfig, logger *zap.Logger) (*SAPEWMClient, error) {
	// Create base URL
	scheme := "http"
	if config.SSLEnabled {
		scheme = "https"
	}
	baseURL := fmt.Sprintf("%s://%s:%d/sap/bc/rest/ewm/%s", 
...
func (c *SAPEWMClient) GetTasks(ctx context.Context, warehouseID string, status string) ([]Task, error) {
...
func (c *SAPEWMClient) GetTask(ctx context.Context, taskID string) (*Task, error) {
...
func (c *SAPEWMClient) UpdateTaskStatus(ctx context.Context, taskID string, status string, message string) error {
...
func (c *SAPEWMClient) GetInventory(ctx context.Context, warehouseID string, zoneID string) ([]InventoryItem, error) {
...
func (c *SAPEWMClient) GetResources(ctx context.Context, warehouseID string) ([]Resource, error) {
...
func (c *SAPEWMClient) executeWithRetry(req *http.Request, response interface{}) error {
	var lastErr error
...
// Task represents a task from SAP EWM
type Task struct {
	ID           string    `json:"id"`
