...
## 🎯 **47 Services Categorized by Layer & Function**
...
| `trip-service` | 8083 | Trip lifecycle management | PostgreSQL, Event Bus |
...
| Service | Port | Purpose | Dependencies |
|---------|------|---------|--------------|
| `telemetry-ingest` | 8090 | Real-time telemetry collection | Kafka, ClickHouse |
...
| `erp-wms-adapters` | 8101 | SAP, Oracle WMS integration | External ERP Systems |
| `erp-integration` | 8102 | General ERP integration | External Systems |
...
| `digital-twin-simulation` | 8122 | Scenario testing and validation | CARLA, Gazebo |
...
Level 4: Business Services (trip-service, dispatch-service, routing-service)
Level 5: Data Services (telemetry-ingest, analytics-service, data-lineage)
