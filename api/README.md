...
│   │   ├── mission-management.yaml      # Trip Service OpenAPI spec
...
services:
  mission-management:
    ...
    base_url: "http://mission-management:8080"
    contract_path: "/api/contracts/v1/mission-management.yaml"
...
node tools/api-versioning/version-manager.js create mission-management minor "Added new trip status"
```
...
# Or use the CLI directly
node tools/api-versioning/version-manager.js deprecate mission-management 1.0.0 "Security vulnerability fixed in 1.1.0"
```
